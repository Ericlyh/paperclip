...
export function RuntimeServicesJsonField({
  ...
  return (
    <Field label={t("adapterRuntime.label.runtimeServicesJson")} hint={help.runtimeServicesJson}>
      <textarea
...
export function PayloadTemplateJsonField({
  ...
  return (
    <Field label={t("adapterRuntime.label.payloadTemplateJson")} hint={help.payloadTemplateJson}>
      <textarea
