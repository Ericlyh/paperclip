...
export function HermesGatewayConfigFields({
  ...
  return (
    <>
      <Field
        label={t("adapterHermes.configFields.apiBaseUrl")}
      ...
      <SecretField
        label={t("adapterHermes.configFields.apiKey")}
      ...
      <Field
        label={t("adapterHermes.configFields.paperclipApiUrl")}
      ...
      <Field
        label={t("adapterHermes.configFields.sessionKeyStrategy")}
      ...
      <Field label={t("adapterHermes.configFields.timeoutSeconds")}>
        <DraftNumberInput
      ...
      <Field
        label={t("adapterHermes.configFields.eventReconnectMs")}
      ...
      <ToggleField
        label={t("adapterHermes.configFields.dangerouslyAllowRemoteHttp")}
      ...
      <Field
        label={t("adapterHermes.configFields.extraHeaders")}
      ...
      <Field label={t("adapterHermes.configFields.instructions")} hint="Optional stable Hermes instructions sent separately from the wake input.">
        <DraftTextarea
          value={instructions}
