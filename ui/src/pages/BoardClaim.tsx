...
export function BoardClaimPage() {
  ...
  if (!status) {
    return <div className="mx-auto max-w-xl py-10 text-sm text-destructive">{t("boardClaim.challengeUnavailableDot")}</div>;
  }
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <Card className="block p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {t("boardClaim.linkedToAuthenticatedUser")}
          </p>
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <Card className="block p-6">
          ...
          <Button asChild className="mt-4">
            <Link to={`/auth?next=${encodeURIComponent(currentPath)}`}>{t("boardClaim.signInOrCreateAccountCta")}</Link>
          </Button>
        </Card>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <Card className="block p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {t("boardClaim.claimBoardDescription")}
        </p>
