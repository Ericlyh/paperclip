...
const PROJECT_SORT_OPTIONS: Array<{ field: ProjectSortField; label: string }> = [
  { field: "name", label: translate("projects.sortName") },
  { field: "updated", label: translate("projects.sortUpdated") },
  { field: "created", label: translate("projects.sortCreated") },
  { field: "targetDate", label: translate("projects.sortTargetDate") },
];
...
export function Projects() {
  ...
  const sortLabel = PROJECT_SORT_OPTIONS.find((option) => option.field === sortField)?.label ?? t("projects.sortName");
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="ghost" size="sm" className="w-fit text-xs" title={t("projects.sort")}>
              ...
              <span>{t("projects.sortLabel", { field: sortLabel })}</span>
            </Button>
          </PopoverTrigger>
