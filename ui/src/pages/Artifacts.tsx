...
export const ARTIFACT_KIND_FILTERS: {
  ...
  { value: "all", labelKey: "artifacts.filterAll", label: "All" },
  { value: "image", labelKey: "artifacts.filterImages", label: "Images" },
  { value: "video", labelKey: "artifacts.filterVideos", label: "Videos" },
  { value: "document", labelKey: "artifacts.filterDocuments", label: "Documents" },
  { value: "text", labelKey: "artifacts.filterText", label: "Text" },
  { value: "file", labelKey: "artifacts.filterFiles", label: "Files" },
];
...
export const ARTIFACT_GROUP_OPTIONS: {
  ...
  { value: "none", labelKey: "artifacts.groupNone", label: "None" },
  { value: "task", labelKey: "artifacts.groupTask", label: "Task" },
  { value: "parent_task", labelKey: "artifacts.groupParentTask", label: "Parent task" },
];
...
export function artifactGroupByLabel(
  value: ArtifactGroupBy,
  translate: (key: string) => string = t,
): string {
  const option = ARTIFACT_GROUP_OPTIONS.find((o) => o.value === value);
  return translate(option?.labelKey ?? "artifacts.groupNone");
}
...
export function Artifacts() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Package} message={t("artifacts.emptySelectCompany")} />;
  }
  ...
  const emptyMessage = showGroupCards
    ? searching
      ? t("artifacts.emptyStacksSearch")
      : t("artifacts.emptyStacks")
    : searching
      ? t("artifacts.emptyArtifactsSearch")
      : viewingSelectedStack
        ? t("artifacts.emptyArtifactsStack")
        : kind === "all"
          ? t("artifacts.emptyArtifacts")
          : t("artifacts.emptyArtifactsOfType");
    ...
    <div className="w-full max-w-6xl space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="relative w-full sm:max-w-sm">
          ...
          {draftQuery.length > 0 ? (
            <button
              ...
              aria-label={t("artifacts.clearSearchAria")}
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                variant="outline"
                size="icon"
                aria-label={t("artifacts.groupAria", { current: artifactGroupByLabel(groupBy, t) })}
            ...
            <DropdownMenuContent align="end" className="w-44">
              <DropdownMenuLabel>{t("artifacts.groupByLabel")}</DropdownMenuLabel>
          ...
          <div className="flex flex-wrap items-center gap-1.5" role="tablist" aria-label={t("artifacts.filterByTypeAria")}>
