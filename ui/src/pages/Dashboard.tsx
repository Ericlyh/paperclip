  ...
  return (
    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
      <label
        ...
        title={t("dashboard.toggleFilter.hideautogeneratedreviewproductivityissues")}
      >
        <Checkbox
      ...
      <label
        className="inline-flex cursor-pointer items-center gap-2 hover:text-foreground"
        title={t("dashboard.toggleFilter.hidetaskswhosetitlestartswithpaperclipcloselintres")}
      >
        <Checkbox
      ...
      <label
        className="inline-flex cursor-pointer items-center gap-2 hover:text-foreground"
        title={t("dashboard.toggleFilter.hidetaskswhosetitlestartswithpapercliphourlylogrot")}
      >
        <Checkbox
      ...
      <label
        className="inline-flex cursor-pointer items-center gap-2 hover:text-foreground"
        title={t("dashboard.toggleFilter.hidetaskswhosetitlestartswithpapercliporlint")}
      >
        <Checkbox
