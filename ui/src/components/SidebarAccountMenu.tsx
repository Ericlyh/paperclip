...
export function SidebarAccountMenu({
  ...
  const secondaryLabel =
    ...
    (deploymentMode === "authenticated" ? t("accountMenu.signedIn") : t("accountMenu.localWorkspaceBoard"));
        ...
        >
          ...
          <div className="-mt-8 px-4 pb-4">
            ...
            <div className="mt-4 space-y-1">
              ...
              />
              <MenuAction
                label={t("accountMenu.feedback")}
                description={t("accountMenu.feedbackDescription")}
                icon={Megaphone}
                href={FEEDBACK_URL}
                external
                onClick={() => setOpen(false)}
