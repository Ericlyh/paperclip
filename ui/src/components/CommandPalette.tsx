    ...
    <CommandDialog open={open} onOpenChange={(v) => {
      ...
      <CommandInput
        placeholder={t("commandPalette.searchPlaceholder", {
          defaultValue: "Search tasks, agents, projects...",
        })}
        value={query}
      ...
      <CommandList>
        <CommandEmpty>
          {showSearchAll ? (
            <span>
              {t("commandPalette.emptyState.pressEnterHint", {
                defaultValue:
                  "No quick task matches. Press ↵ to search all or keep typing to refine.",
              })}
            </span>
          ) : (
            t("commandPalette.emptyState.noResults", { defaultValue: "No results found." })
          )}
        </CommandEmpty>

        {showSearchAll ? (
          <CommandGroup heading={t("commandPalette.heading.search", { defaultValue: "Search" })}>
            <CommandItem
            ...
            >
              ...
              <span className="ml-auto inline-flex items-center gap-1 text-xs text-muted-foreground">
                <span>{t("commandPalette.openFullSearch", { defaultValue: "open full search" })}</span>
        ...
        <CommandGroup heading={t("commandPalette.heading.quickFilters", { defaultValue: "Quick filters" })}>
        ...
        {showPromotedProjects && (
          <>
            <CommandGroup heading={t("commandPalette.heading.projects", { defaultValue: "Projects" })}>
        ...
        <CommandGroup heading={t("commandPalette.heading.actions", { defaultValue: "Actions" })}>
          <CommandItem
            onSelect={() => {
              setOpen(false);
              openNewIssue();
          ...
          >
            ...
            {t("commandPalette.action.createTask", { defaultValue: "Create new task" })}
          ...
          {onIssueDetail && fileViewerEnabled && (
            ...
            >
              ...
              {t("commandPalette.action.openFileInIssue", { defaultValue: "Open file in this issue..." })}
          ...
          >
            ...
            {t("commandPalette.action.createAgent", { defaultValue: "Create new agent" })}
          </CommandItem>
          <CommandItem onSelect={() => go("/projects")}>
            <Plus className="mr-2 h-4 w-4" />
            {t("commandPalette.action.createProject", { defaultValue: "Create new project" })}
          </CommandItem>
        </CommandGroup>

        <CommandSeparator />

        <CommandGroup heading={t("commandPalette.heading.pages", { defaultValue: "Pages" })}>
          <CommandItem onSelect={() => go("/dashboard")}>
            <LayoutDashboard className="mr-2 h-4 w-4" />
            {t("commandPalette.page.dashboard", { defaultValue: "Dashboard" })}
          </CommandItem>
          <CommandItem onSelect={() => go("/inbox")}>
            <Inbox className="mr-2 h-4 w-4" />
            {t("commandPalette.page.inbox", { defaultValue: "Inbox" })}
          </CommandItem>
          <CommandItem onSelect={() => go("/issues")}>
            <CircleDot className="mr-2 h-4 w-4" />
            {t("commandPalette.page.tasks", { defaultValue: "Tasks" })}
          </CommandItem>
          <CommandItem onSelect={() => go("/projects")}>
            <Hexagon className="mr-2 h-4 w-4" />
            {t("commandPalette.page.projects", { defaultValue: "Projects" })}
          </CommandItem>
          <CommandItem onSelect={() => go("/goals")}>
            <Target className="mr-2 h-4 w-4" />
            {t("commandPalette.page.goals", { defaultValue: "Goals" })}
          </CommandItem>
          <CommandItem onSelect={() => go("/agents")}>
            <Bot className="mr-2 h-4 w-4" />
            {t("commandPalette.page.agents", { defaultValue: "Agents" })}
          </CommandItem>
          <CommandItem onSelect={() => go("/costs")}>
            <DollarSign className="mr-2 h-4 w-4" />
            {t("commandPalette.page.costs", { defaultValue: "Costs" })}
          </CommandItem>
          <CommandItem onSelect={() => go("/activity")}>
            <History className="mr-2 h-4 w-4" />
            {t("commandPalette.page.activity", { defaultValue: "Activity" })}
          </CommandItem>
        </CommandGroup>
        ...
        {visibleIssues.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("commandPalette.heading.tasks", { defaultValue: "Tasks" })}>
        ...
        {agents.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("commandPalette.heading.agents", { defaultValue: "Agents" })}>
