...
export function RoutineVariablesEditor({
  ...
  const { t } = useTranslation('routineVariablesEditor');
              ...
              <div className="space-y-1.5 md:col-span-2">
                ...
                {variable.type === "textarea" ? (
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="__unset__">{t('noDefault')}</SelectItem>
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    ...
                    <div className="space-y-1.5">
                      <Label className="text-xs">{t('defaultOption')}</Label>
                      <Select
                  ...
                  <Input
                    ...
                    placeholder={variable.type === "number" ? "42" : t('defaultValuePlaceholder')}
                  />
                )}
              </div>
            </div>
    ...
    <>
      ...
      <Dialog open={helpOpen} onOpenChange={setHelpOpen}>
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            <DialogTitle>{t('routineVariables')}</DialogTitle>
            <DialogDescription>
              {t('routineVariablesDescription')}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-5 text-sm">
            <section className="space-y-2">
              ...
              <p className="text-muted-foreground">
                {t('customVariablesDescription')}
              </p>
              <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
                <li>{t('variableNameRules')}</li>
                <li>{t('variableTypeDescription')}</li>
                <li>{t('dateVariableNaming')}</li>
                <li>{t('sameNameReused')}</li>
              </ul>
            </section>
