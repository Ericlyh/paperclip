    ...
    return (
      <div className={cn("relative", cards && "space-y-6")}>
        ...
        <div className={cn(!cards && "border-b border-border")}>
          {cards
            ? <h3 className="mb-3 text-sm font-medium">{t("agentConfig.secretAccessHeader")}</h3>
            : <div className="px-4 py-2 text-xs font-medium text-muted-foreground">{t("agentConfig.secretAccessHeader")}</div>
          }
    ...
    <div className={cn("relative", cards && "space-y-6")}>
          ...
          <div className={cn(cards ? "border border-border rounded-lg p-4 space-y-3" : "px-4 pb-3 space-y-3")}>
            <Field label={t("agentConfig.labelName")} hint={help.name}>
              <DraftInput
                ...
                placeholder={t("agentConfig.placeholderAgentName")}
              />
            </Field>
            <Field label={t("agentConfig.labelTitle")} hint={help.title}>
              <DraftInput
                value={eff("identity", "title", props.agent.title ?? "")}
                onCommit={(v) => mark("identity", "title", v || null)}
                immediate
                className={inputClass}
                placeholder={t("agentConfig.placeholderRole")}
              />
            </Field>
            <Field label={t("agentConfig.labelReportsTo")} hint={help.reportsTo}>
              <ReportsToPicker
            ...
            <Field label={t("agentConfig.labelCapabilities")} hint={help.capabilities}>
              <MarkdownEditor
                value={eff("identity", "capabilities", props.agent.capabilities ?? "") ?? ""}
                onChange={(v) => mark("identity", "capabilities", v || null)}
                placeholder={t("agentConfig.placeholderCapabilities")}
            ...
            {isLocal && !props.hidePromptTemplate && (
              <>
                <Field label={t("agentConfig.labelPromptTemplate")} hint={help.promptTemplate}>
                  <MarkdownEditor
                    value={eff(
                      "adapterConfig",
                      "promptTemplate",
                    ...
                    placeholder={t("agentConfig.placeholderPromptTemplate")}
      ...
      {forcedKubernetes ? (
        ...
        <div className={cn(!cards && (isCreate ? "border-t border-border" : "border-b border-border"))}>
          ...
          <div className={cn(cards ? "border border-border rounded-lg p-4 space-y-3" : "px-4 pb-3 space-y-3")}>
            <Field
              label={t("agentConfig.labelDefaultEnvironment")}
      ...
      <div className={cn(!cards && (isCreate ? "border-t border-border" : "border-b border-border"))}>
        ...
        <div className={cn(cards ? "border border-border rounded-lg p-4 space-y-3" : "px-4 pb-3 space-y-3")}>
          {showAdapterTypeField && (
            <Field label={t("agentConfig.labelAdapterType")} hint={help.adapterType}>
              <AdapterTypeDropdown
                value={adapterType}
          ...
          {showLegacyWorkingDirectoryField && (
            <Field label={t("agentConfig.labelWorkingDirectory")} hint={help.cwd}>
              <div className="flex items-center gap-2 rounded-md border border-border px-2.5 py-1.5">
                ...
                <DraftInput
                  ...
                  placeholder={t("agentConfig.placeholderPathToProject")}
                />
                <ChoosePathButton />
              </div>
            </Field>
        ...
        <div className={cn(!cards && "border-b border-border")}>
          ...
          <div className={cn(cards ? "border border-border rounded-lg p-4 space-y-3" : "px-4 pb-3 space-y-3")}>
              ...
              {supportsModelProfiles && (
                <div className="text-(length:--text-micro) uppercase tracking-wide text-muted-foreground">{t("agentConfig.primaryModelHeader")}</div>
              )}
              <ModelDropdown
                models={models}
              ...
              {!isCreate && typeof config.bootstrapPromptTemplate === "string" && config.bootstrapPromptTemplate && (
                <>
                  <Field label={t("agentConfig.labelBootstrapPrompt")} hint={help.bootstrapPrompt}>
                    <MarkdownEditor
                      value={eff(
                        "adapterConfig",
                      ...
                      placeholder={t("agentConfig.placeholderBootstrapPrompt")}
                      contentClassName="min-h-(--sz-44px) text-sm font-mono"
                      imageUploadHandler={async (file) => {
              ...
              <Field label={t("agentConfig.labelExtraArgs")} hint={help.extraArgs}>
                <DraftInput
                  value={
                    isCreate
                      ? val!.extraArgs
                  ...
                  className={inputClass}
                  placeholder={t("agentConfig.placeholderExtraArgs")}
                />
              </Field>

              <Field label={t("agentConfig.labelEnvVars")} hint={help.envVars}>
                <EnvironmentVariablesEditor
              ...
              {!isCreate && (
                <>
                  <Field label={t("agentConfig.labelTimeout")} hint={help.timeoutSec}>
                    <DraftNumberInput
                      value={eff(
                        "adapterConfig",
                        "timeoutSec",
                  ...
                  <Field label={t("agentConfig.labelGraceSec")} hint={help.graceSec}>
                    <DraftNumberInput
                      value={eff(
                        "adapterConfig",
                        "graceSec",
      ...
      {isCreate && showCreateRunPolicySection ? (
        <div className={cn(!cards && "border-b border-border")}>
          ...
          <div className={cn(cards ? "border border-border rounded-lg p-4 space-y-3" : "px-4 pb-3 space-y-3")}>
            <ToggleWithNumber
              label={t("agentConfig.labelHeartbeatOnInterval")}
        ...
        <div className={cn(!cards && "border-b border-border")}>
          ...
          <div className={cn(cards ? "border border-border rounded-lg overflow-hidden" : "")}>
            ...
            <CollapsibleSection
              title={t("agentConfig.sectionAdvancedRunPolicy")}
              bordered={cards}
            ...
            <div className="space-y-3">
              <ToggleField
                label={t("agentConfig.labelWakeOnDemand")}
              ...
              />
              <Field label={t("agentConfig.labelCooldownSec")} hint={help.cooldownSec}>
                <DraftNumberInput
                  value={eff(
                    "heartbeat",
                    "cooldownSec",
              ...
              <Field label={t("agentConfig.labelMaxConcurrentRuns")} hint={help.maxConcurrentRuns}>
                <DraftNumberInput
                  value={eff(
                    "heartbeat",
                    "maxConcurrentRuns",
              ...
              <div className="rounded-md border border-border/70 px-3 py-2">
                <ToggleField
                  label={t("agentConfig.labelContinueAfterMaxTurn")}
                ...
                {maxTurnContinuationEnabled ? (
                  <div className="mt-3 grid gap-3 sm:grid-cols-2">
                    <Field label={t("agentConfig.labelContinuationAttempts")} hint={help.maxTurnContinuationMaxAttempts}>
                      <DraftNumberInput
                    ...
                    <Field label={t("agentConfig.labelContinuationDelay")} hint={help.maxTurnContinuationDelaySec}>
                      <DraftNumberInput
  ...
  if (status === "authenticated") {
    return (
      <div className="flex items-center gap-2 text-(length:--text-micro) text-foreground">
        ...
        <span>{t("agentConfig.authSuccessMessage")}</span>
      </div>
    );
  }
  const label =
  ...
  return (
    <div className="rounded-md border border-border bg-muted/40 px-3 py-2 space-y-2">
      <div className="flex items-center justify-between gap-2">
        <span className="text-xs font-medium text-foreground">{t("agentConfig.signInToSandbox")}</span>
      ...
      <div role="status" aria-live="polite" className="space-y-2 empty:hidden">
        {isActive && !prompt && (
          <div className="flex items-center gap-2 text-(length:--text-micro) text-muted-foreground">
            ...
            <span>{t("agentConfig.preparingLogin")}</span>
          </div>
        )}
        ...
        {isActive && prompt && (
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <AdapterLoginCopyButton value={prompt.code} label={t("agentConfig.copyCode")} />
          </div>
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              <div className="text-(length:--text-micro) uppercase tracking-wide text-muted-foreground">
            ...
            <div className="flex items-center">
              <AdapterLoginCopyButton value={prompt.url} label={t("agentConfig.copyUrl")} />
              <Button
                asChild
                type="button"
                variant="ghost"
                size="icon-xs"
                aria-label={t("agentConfig.openAuthPage")}
                title={t("agentConfig.openAuthPage")}
                className="text-muted-foreground hover:text-foreground"
              >
  ...
  return (
    <div className="rounded-md border border-border bg-muted/40 px-3 py-2 space-y-2">
      ...
      {appliedStored && (
        <div className="flex items-center gap-2 text-(length:--text-micro) text-foreground">
          <Check className="size-3 shrink-0" />
          <span>{t("agentConfig.claudeLoginBound")}</span>
        </div>
      )}
      ...
      <div role="status" aria-live="polite" className="space-y-2 empty:hidden">
        ...
        {isActive && authorizationUrl && !isCompleting && (
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center">
                <AdapterLoginCopyButton value={authorizationUrl} label={t("agentConfig.copyUrl")} />
                <Button
                  asChild
                  type="button"
                  variant="ghost"
                  size="icon-xs"
                  aria-label={t("agentConfig.openAuthzPage")}
                  title={t("agentConfig.openAuthzPage")}
                  className="text-muted-foreground hover:text-foreground"
                >
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                <input
                  aria-label={t("agentConfig.browserCodeLabel")}
                  type="text"
                  autoComplete="off"
                  spellCheck={false}
                  value={browserCode}
        ...
        {isCompleting && (
          <div className="flex items-center gap-2 text-(length:--text-micro) text-muted-foreground">
            <Loader2 className="size-3 animate-spin shrink-0" />
            <span>{t("agentConfig.completingLogin")}</span>
          </div>
        )}
      ...
      <PopoverContent className="w-(--radix-popover-trigger-width) p-1" align="start">
        {adapterList.map((item) => (
          ...
          >
            ...
            {item.comingSoon && (
              <span className="text-(length:--text-nano) text-muted-foreground">{t("agentConfig.comingSoon")}</span>
            )}
          </button>
        ))}
      </PopoverContent>
...
export function ModelDropdown({
  ...
  return (
    <Field label={t("agentConfig.labelModel")} hint={help.model}>
      <Popover
        open={open}
...
function ThinkingEffortDropdown({
  ...
  return (
    <Field label={t("agentConfig.labelThinkingEffort")} hint={help.thinkingEffort}>
