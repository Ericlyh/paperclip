      ...
      {archivePending ? (
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-destructive font-medium">
            {isArchive ? t("projectProperties.archive") : t("projectProperties.unarchive")} &ldquo;{project.name}&rdquo;?
          </span>
          <Button
            size="sm"
            variant="destructive"
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="space-y-0.5">
                    ...
                    <div className="text-xs text-muted-foreground">
                      {t("projectProperties.enableIsolatedTaskCheckoutsHelp")}
                    </div>
                  </div>
                  {onUpdate || onFieldUpdate ? (
                    <ToggleSwitch
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between gap-3">
                      <div className="space-y-0.5">
                        ...
                        <div className="text-(length:--text-micro) text-muted-foreground">
                          {t("projectProperties.newTasksDefaultToIsolatedCheckoutHelp")}
                        </div>
                      </div>
                      <ToggleSwitch
                    ...
                    {executionWorkspaceAdvancedOpen ? (
                      <div className="space-y-3">
                        ...
                        <p className="text-(length:--text-micro) text-muted-foreground">
                          {t("projectProperties.provisionRunsInsideWorktree")}
                        </p>
                      </div>
                    ) : null}
                  </div>
