...
export function ChoosePathButton() {
  const { t } = useTranslation('agentConfigPrimitives');
  ...
  return (
    <>
      ...
      >
        {t('choosePathButton.choose')}
      </button>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t('choosePathButton.specifyPathManually')}</DialogTitle>
            <DialogDescription>
              {t('choosePathButton.browserSecurityBlocks')}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 text-sm">
            <section className="space-y-1.5">
              <p className="font-medium">{t('choosePathButton.macosFinder')}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t('choosePathButton.findFolderFinder')}</li>
                <li>{t('choosePathButton.holdOptionRightClick')}</li>
                <li>{t('choosePathButton.clickCopyAsPathname')}</li>
                <li>{t('choosePathButton.pasteResultIntoInput')}</li>
              </ol>
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t('choosePathButton.windowsFileExplorer')}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t('choosePathButton.findFolderExplorer')}</li>
                <li>{t('choosePathButton.holdShiftRightClick')}</li>
                <li>{t('choosePathButton.clickCopyAsPath')}</li>
                <li>{t('choosePathButton.pasteResultIntoInput')}</li>
              </ol>
              <p className="rounded-md bg-muted px-2 py-1 font-mono text-xs">
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t('choosePathButton.terminalFallback')}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t('choosePathButton.runCdPath')}</li>
                <li>{t('choosePathButton.runPwd')}</li>
                <li>{t('choosePathButton.copyOutputPasteInput')}</li>
              </ol>
            </section>
          </div>
          <DialogFooter>
            <Button variant="outline" onClick={() => setOpen(false)}>
              {t('choosePathButton.ok')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
